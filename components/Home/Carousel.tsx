...
import {
  mainCarouselMediaByIndex,
  mainCarouselTextByIndex,
} from "../../lib/MainCarouselMedia";
...
export const CarouselComponent = ({ theme }: any) => {
                ...
                >
                  <div className={styles.embla_slide_img_container}>
                    <Image
                      ...
                      src={mainCarouselMediaByIndex(index)}
                      layout="fill"
                  ...
                  <div className={styles.embla_slide_text}>
                    <h2 className={styles.title}>
                      {mainCarouselTextByIndex(index).title}
                    </h2>
                    <p className={styles.subtitle}>
                      {mainCarouselTextByIndex(index).subtitle}
                    </p>
                  </div>
                </div>
              </div>
